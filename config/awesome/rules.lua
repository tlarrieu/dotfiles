...
awful.rules.rules = {
  ...
  { rule = { class = "Plugin-container" }, properties = { opacity = 1.0, floating = true, ontop = true, border = 0 } },
  ...
  { rule = { class = "MPlayer" }, properties = { opacity = 1.0, floating = true, ontop = true } },
  { rule = { class = "Vlc" }, properties = { opacity = 1.0, floating = true, ontop = true } },

  { rule = { class = "mednafen" }, properties = { opacity = 1.0, floating = true, ontop = true, } },
  { rule = { class = "Phoenix" }, properties = { opacity = 1.0, floating = true, ontop = true, fullscreen = true } }, -- bsnes
  { rule = { class = "Gvba" }, properties = { opacity = 1.0, floating = true } },
  { rule = { class = "Minecraft" }, properties = { opacity = 1.0, floating = true } },
