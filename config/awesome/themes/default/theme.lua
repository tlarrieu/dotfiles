...
-- theme.wallpaper_cmd = { "awsetbg /home/smockey/Pictures/Wallpapers/star_wars.jpg" }
theme.wallpaper_cmd = { "eval $(cat ~/.fehbg)" }
...
theme.awesome_icon = "/home/smockey/.config/awesome/themes/default/icon.png"
