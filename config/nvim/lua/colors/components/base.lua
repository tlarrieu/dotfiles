return function(palette)
  ...
  vim.api.nvim_set_hl(0, 'Special', { fg = palette.yellow.base })
  ...
  vim.api.nvim_set_hl(0, '@string.escape', { fg = palette.magenta.base, bold = true })
  ...
  vim.api.nvim_set_hl(0, '@variable.builtin', { fg = palette.magenta.base })
  ...
  vim.api.nvim_set_hl(0, '@markup.heading.1', { fg = palette.red.base })
