return function(palette)
  ...
  -- edifact
  vim.api.nvim_set_hl(0, 'edifactTag', { link = 'Type' })
  vim.api.nvim_set_hl(0, 'edifactData', { fg = palette.green.base })
  ...
  vim.api.nvim_set_hl(0, 'edifactTagSEQ', { fg = palette.red.base, bg = palette.red.dimmer, bold = true })
  vim.api.nvim_set_hl(0, 'edifactTagIND', { fg = palette.fg.dimmer })
end
