  ...
  opts = {
    ...
    groups = {
      all = {
        ...
        WinBar = { fg = 'palette.fg.dim', bg = 'palette.bg0', style = 'NONE' },
        WinBarNC = { fg = 'palette.fg.dimmer', bg = 'palette.bg0', style = 'NONE' },
        ...
        DropBarIconKindEnum = { link = 'DropBarIconKindType' },
        DropBarIconKindCall = { link = 'DropBarIconKindDefault' },
        DropBarIconKindNull = { link = 'DropBarIconKindDefault' },
        DropBarIconKindConstant = { link = 'DropBarIconKindDefault' },
        DropBarIconKindStatement = { link = 'DropBarIconKindDefault' },
        DropBarIconKindFunction = { fg = 'palette.blue' },
        DropBarIconKindMethod = { link = 'DropBarIconKindFunction' },
        DropBarIconKindMarkdownH1 = { link = '@markup.heading.1' },
        DropBarIconKindMarkdownH2 = { link = '@markup.heading.2' },
        DropBarIconKindMarkdownH3 = { link = '@markup.heading.3' },
        DropBarIconKindMarkdownH4 = { link = '@markup.heading.4' },
        DropBarIconKindMarkdownH5 = { link = '@markup.heading.5' },
        DropBarIconKindMarkdownH6 = { link = '@markup.heading.6' },
        ...
        LazyCommit = { fg = 'palette.magenta', style = 'italic' },
        ...
        NeogitActiveItem = { bg = 'palette.sel0' },
        NeogitPopupBranchName = { link = 'NeogitBranch' },
        NeogitPopupSectionTitle = { fg = 'palette.fg.dimmer', style = 'bold' },
        NeogitPopupActionKey = { fg = 'palette.pink' },
        NeogitPopupOptionKey = { fg = 'palette.fg.dimmer' },
        NeogitPopupSwitchKey = { link = 'NeogitPopupOptionKey' },
        NeogitPopupConfigKey = { link = 'NeogitPopupOptionKey' },
        NeogitPopupSwitchEnabled = { fg = 'palette.yellow' },
        NeogitPopupConfigEnabled = { link = 'NeogitPopupSwitchEnabled' },
        NeogitPopupOptionEnabled = { link = 'NeogitPopupSwitchEnabled' },
        NeogitPopupActionDisabled = { fg = 'palette.fg.dimmer', style = 'italic' },
        NeogitPopupSwitchDisabled = { fg = 'palette.fg.dimmer', style = 'italic' },
        ...
        NeogitObjectId = { fg = 'palette.magenta.dim', style = 'italic' },
        ...
        NeogitTagDistance = { fg = 'palette.fg.dimmer', style = 'italic' },
        NeogitSectionHeader = { fg = 'palette.fg.dimmer', style = 'bold' },
        NeogitStagedchanges = { fg = 'palette.green', bg = 'palette.green.dimmer', style = 'bold' },
        NeogitUnstagedchanges = { fg = 'palette.yellow', bg = 'palette.yellow.dimmer', style = 'bold' },
        ...
        NeogitDiffContextHighlight = { fg = 'palette.fg.dimmer', bg = 'palette.bg2' },
        NeogitDiffContextCursor = { fg = 'palette.fg.dimmer', bg = 'palette.bg2', style = 'bold' },
        NeogitHunkHeader = { fg = 'palette.blue', bg = 'NONE' },
        NeogitHunkHeaderHighlight = { fg = 'palette.blue', bg = 'palette.blue.dimmer' },
        NeogitHunkHeaderCursor = { fg = 'palette.blue', bg = 'palette.blue.dimmer', style = 'bold' },
        NeogitHunkMergeHeader = { fg = 'palette.fg.dimmer', bg = 'palette.sel0' },
        NeogitHunkMergeHeaderHighlight = { fg = 'palette.fg.dimmer', bg = 'palette.sel1' },
        NeogitHunkMergeHeaderCursor = { fg = 'palette.fg.dimmer', bg = 'palette.sel1', style = 'bold' },
        NeogitGraphAuthor = { fg = 'palette.fg.dimmer' },
        NeogitGraphOrange = { fg = 'palette.orange.dim' },
        NeogitGraphBoldOrange = { fg = 'palette.orange.dim', style = 'bold' },
        NeogitGraphYellow = { fg = 'palette.yellow.dim' },
        NeogitGraphBoldYellow = { fg = 'palette.yellow.dim', style = 'bold' },
        NeogitGraphGray = { fg = 'palette.fg.dim' },
        NeogitGraphBoldGray = { fg = 'palette.fg.dim', style = 'bold' },
        NeogitGraphRed = { fg = 'palette.red.dim' },
        NeogitGraphBoldRed = { fg = 'palette.red.dim', style = 'bold' },
        NeogitGraphBlue = { fg = 'palette.blue.dim' },
        NeogitGraphBoldBlue = { fg = 'palette.blue.dim', style = 'bold' },
        NeogitGraphCyan = { fg = 'palette.cyan.dim' },
        NeogitGraphBoldCyan = { fg = 'palette.cyan.dim', style = 'bold' },
        NeogitGraphGreen = { fg = 'palette.green.dim' },
        NeogitGraphBoldGreen = { fg = 'palette.green.dim', style = 'bold' },
        NeogitGraphPurple = { fg = 'palette.magenta.dim' },
