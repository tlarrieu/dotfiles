  ...
  opts = {
    ...
    groups = {
      all = {
        ...
        NeogitChangeNewfile = { fg = 'palette.green.dim', style = 'italic' },
        NeogitChangeModified = { fg = 'palette.yellow.dim', style = 'italic' },
        NeogitChangeCopied = { fg = 'palette.green.dim', style = 'italic' },
        NeogitChangeAdded = { fg = 'palette.green.dim', style = 'italic' },
        NeogitChangeDeleted = { fg = 'palette.red.dim', style = 'italic' },
        NeogitSubtleText = { fg = 'palette.fg.dim', style = 'italic' },
        NeogitStagedchanges = { fg = 'palette.green', bg = 'palette.green.dim', style = 'bold' },
        NeogitUnstagedchanges = { fg = 'palette.yellow', bg = 'palette.yellow.dim', style = 'bold' },
        NeogitUnmergedchanges = { fg = 'palette.magenta', bg = 'palette.magenta.dim', style = 'bold' },
        NeogitUntrackedfiles = { fg = 'palette.red', bg = 'palette.red.dim', style = 'bold' },
        NeogitStashes = { fg = 'palette.fg.dim', style = 'bold' },
        NeogitRecentcommits = { fg = 'palette.fg.dimmer', style = 'bold' },
        NeogitObjectId = { fg = 'palette.magenta', style = 'italic' },
        NeogitBranch = { link = '@git.branch' },
        NeogitBranchHead = { link = '@git.branch' },
