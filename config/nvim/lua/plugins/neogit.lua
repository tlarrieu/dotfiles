return {
  ...
  config = function(_, opts)
    ...
    vim.keymap.set('n', '<leader>gs', ':silent !git stash --quiet<cr><cmd>checktime<cr>', { desc = 'Git stash' })
    vim.keymap.set('n', '<leader>gS', ':silent !git stash pop --quiet<cr><cmd>checktime<cr>', { desc = 'Git stash pop' })
  end
}
