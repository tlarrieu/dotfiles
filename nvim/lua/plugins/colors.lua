  ...
  opts = {
    ...
    on_highlights = function(c, _)
      ...
      return {
        ...
        DiagnosticFloatingUnnecessary = { link = 'DiagnosticUnnecessary' },
        ...
        DiagnosticVirtualTextUnnecessary = { link = 'DiagnosticUnnecessary' },
        ...
        FidgetGroup = { fg = c.orange, bg = c.none, bold = true, italic = true },
        ...
        MarkviewBlockQuoteDefault = { fg = c.mix_fg, bg = c.none, italic = false },
        MarkviewBlockQuoteError = { fg = c.red, bg = c.none, italic = false, nocombine = true },
        MarkviewBlockQuoteNote = { fg = c.blue, bg = c.none, italic = false, nocombine = true },
        MarkviewBlockQuoteOk = { fg = c.green, bg = c.none, italic = false, nocombine = true },
        MarkviewBlockQuoteSpecial = { fg = c.yellow, bg = c.none, italic = false, nocombine = true },
        MarkviewBlockQuoteWarn = { fg = c.yellow, bg = c.none, italic = false, nocombine = true },
        MarkviewHeading1 = { fg = c.magenta, bg = c.mix_bg, underline = true, nocombine = true },
        ...
        MarkviewCheckboxChecked = { fg = c.green, bg = c.none },
        MarkviewCheckboxUnchecked = { fg = c.yellow, bg = c.none },
        MarkviewCheckboxStriked = { fg = c.mix_fg, bg = c.none, strikethrough = true },
        MarkviewGradient0 = { fg = '#cccdc1', bg = c.none },
        MarkviewGradient1 = { fg = '#c4c8bd', bg = c.none },
        MarkviewGradient2 = { fg = '#bdc3b9', bg = c.none },
        MarkviewGradient3 = { fg = '#b6bfb5', bg = c.none },
        MarkviewGradient4 = { fg = '#afbab1', bg = c.none },
        MarkviewGradient5 = { fg = '#a9b5ae', bg = c.none },
        MarkviewGradient6 = { fg = '#a2b0aa', bg = c.none },
        MarkviewGradient7 = { fg = '#9daaa7', bg = c.none },
        MarkviewGradient8 = { fg = '#97a5a3', bg = c.none },
        MarkviewGradient9 = { fg = '#92a0a0', bg = c.none },
        ...
        GitSignsCurrentLineBlame = { fg = c.mix_fg, bg = c.dim_bg, underline = true, italic = true },
        ...
        AvanteStateSpinnerFailed = paint('red'),
        AvanteStateSpinnerThinking = paint('violet'),
        AvanteStateSpinnerSearching = paint('violet'),
        AvanteStateSpinnerSucceeded = paint('green'),
