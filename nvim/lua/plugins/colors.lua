  ...
  opts = {
    ...
    on_highlights = function(c, _)
      ...
      return {
        ...
        ['MarkviewHeading1'] = paint('magenta'),
        ['MarkviewHeading2'] = paint('green'),
        ['MarkviewHeading3'] = paint('blue'),
        ['MarkviewHeading4'] = paint('cyan'),
        ['MarkviewHeading5'] = paint('violet'),
        ['MarkviewHeading6'] = paint('orange'),
        ...
        ['MarkviewPalette4'] = paint('cyan'),
        ['MarkviewPalette5'] = paint('violet'),
        ['MarkviewPalette6'] = paint('orange'),
        ...
        ['MarkviewPalette4Sign'] = { fg = c.cyan, bg = c.none },
        ['MarkviewPalette5Sign'] = { fg = c.violet, bg = c.none },
        ['MarkviewPalette6Sign'] = { fg = c.orange, bg = c.none },
