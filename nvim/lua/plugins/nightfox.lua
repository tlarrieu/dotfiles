  ...
  opts = {
    ...
    groups = {
      all = {
        ...
        ['@markup.raw.block'] = { fg = 'palette.orange', bg = 'none' },
        ...
        MarkviewCodeLabel = { fg = 'palette.bg0', bg = 'palette.orange', style = 'bold' },
        ...
        MarkviewBlockQuoteSpecial = { fg = 'palette.orange', bg = 'none', style = 'NONE' },
        MarkviewBlockQuoteWarn = { fg = 'palette.orange', bg = 'none', style = 'NONE' },
