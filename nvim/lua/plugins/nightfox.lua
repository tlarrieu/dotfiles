return {
  ...
  opts = {
    ...
    palettes = {
      ...
      nordfox = {
        black   = { base = '#575279', dim = '#363a4b' },
        blue    = { base = '#286983', dim = '#2d3f4d' },
        cyan    = { base = '#56949f', dim = '#364753' },
        green   = { base = '#618774', dim = '#45504f' },
        magenta = { base = '#907aa9', dim = '#494656' },
        orange  = { base = '#d7827e', dim = '#4d4449' },
        pink    = { base = '#d685af', dim = '#4b4559' },
        red     = { base = '#b4637a', dim = '#4b3d48' },
        white   = { base = '#e5e9f0', dim = '#535863' },
        yellow  = { base = '#ea9d34', dim = '#54524f' },
      },
    },
    groups = {
      all = {
