  ...
  opts = {
    ...
    groups = {
      all = {
        ...
        fugitiveHeader = { fg = 'palette.green', bg = 'none' },
        fugitiveHelpTag = { fg = 'palette.pink', bg = 'none' },
        fugitiveSymbolicRef = { link = '@git.branch' },
        fugitiveHeading = { fg = 'palette.comment', style = 'bold' },
        ...
        ['@keyword.git_rebase.pick'] = { fg = 'palette.green', bg = 'palette.green.dim' },
        ['@keyword.git_rebase.reword'] = { fg = 'palette.blue', bg = 'palette.blue.dim' },
        ['@keyword.git_rebase.edit'] = { fg = 'palette.blue', bg = 'palette.blue.dim' },
        ['@keyword.git_rebase.squash'] = { fg = 'palette.yellow', bg = 'palette.yellow.dim' },
        ['@keyword.git_rebase.fixup'] = { fg = 'palette.yellow', bg = 'palette.yellow.dim' },
        ['@keyword.git_rebase.exec'] = { fg = 'palette.pink', bg = 'palette.pink.dim' },
        ['@keyword.git_rebase.break'] = { fg = 'palette.pink', bg = 'palette.pink.dim' },
        ['@keyword.git_rebase.drop'] = { fg = 'palette.red', bg = 'palette.red.dim' },
        ['@keyword.git_rebase.label'] = { fg = 'palette.pink', bg = 'palette.pink.dim' },
        ['@keyword.git_rebase.reset'] = { fg = 'palette.pink', bg = 'palette.pink.dim' },
        ['@keyword.git_rebase.merge'] = { fg = 'palette.pink', bg = 'palette.pink.dim' },
        ['@keyword.git_rebase.update-ref'] = { fg = 'palette.pink', bg = 'palette.pink.dim' },
