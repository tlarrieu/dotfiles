...
crontab:
  ...
  0 19 * * * ~/git/dotfiles/coloriage/coloriage set dark
  0 9 * * * ~/git/dotfiles/coloriage/coloriage set light
  CRONTAB

[group("other/repos"), doc("clone every repos")]
repos: curriculum neorg rss accounting
